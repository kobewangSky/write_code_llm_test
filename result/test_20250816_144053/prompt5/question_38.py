...
# To find the fewest coins that sum to 23 using unlimited coins of denominations `[1, 5, 10, 25]`, we can use the classic dynamic‑programming “coin‑change” method.
# 
