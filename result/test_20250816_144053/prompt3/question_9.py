...
# I balance human and AI by providing a clear, well‑commented implementation that humans can easily understand and verify, while using AI to produce it efficiently.  
# 
# ```python
# def fibonacci(n: int) -> int:
#     """
