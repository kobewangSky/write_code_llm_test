...
# I balance human and AI by offering a concise, well‑commented DP solution that humans can easily understand while leveraging AI to produce the code quickly.
# 
# ```python
# def tsp_dp(dist):
#     n = len(dist)
