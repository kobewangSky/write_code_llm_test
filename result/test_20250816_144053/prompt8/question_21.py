...
# I implemented the Held‑Karp dynamic‑programming algorithm with bitmasking to compute the optimal tour length in O(n²·2ⁿ) time, which is efficient for 4 cities.
# 
# ```python
# def tsp_dp(dist):
#     n = len(dist)
