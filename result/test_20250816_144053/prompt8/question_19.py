...
# I implemented a deterministic consistent‑hashing ring using MD5 hashes and bisect to map keys to the nearest virtual node, then printed the node that “user123” maps to.  
# 
# ```python
# import hashlib
# import bisect
