# ==========================================
# Prompt Name: prompt8
# Question 14: Implement LRU Cache: Design and implement an LRU (Least Recently Used) cache data structure that sup...
# Expected: -1
# Actual: -1
# Status: ✅ PASSED
# Time: 0.01s
...
# 
# ---
# Now please solve the new question: Implement LRU Cache: Design and implement an LRU (Least Recently Used) cache data structure that supports get(key) and put(key, value) operations with O(1) time complexity. With capacity 2, execute: put(1,1), put(2,2), get(1), put(3,3), get(2), and output the result of the final get(2).
# ==========================================

# ==========================================
# LLM original response:
# The code implements a doubly‑linked list combined with a hash map for O(1) access and updates, and demonstrates the sequence of operations to show that the final `get(2)` returns `-1` due to eviction.  
# ```python
# class LRUCache:
#     def __init__(self, capacity: int):
#         self.capacity = capacity
