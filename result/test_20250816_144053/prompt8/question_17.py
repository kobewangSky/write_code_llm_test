...
# I implemented a Union‑Find with path compression and union‑by‑rank to ensure near‑constant‑time operations, then executed the specified unions and comparisons to produce the final boolean result.  
# 
# ```python
# class UnionFind:
#     def __init__(self, n):
