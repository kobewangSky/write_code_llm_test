...
# We have to provide the solution to a new question: "Implement a function to check if two strings are anagrams. Test with 'listen' and 'silent' and output the result."
# 
