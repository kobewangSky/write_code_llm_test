...
# Here’s a straightforward implementation that builds the suffix array for **“banana”** and prints the indices together with the corresponding suffixes in the required format:
# 
# ```python
# def suffix_array(text):
#     # Build the list of suffixes together with their starting indices
