...
# The optimal strategy is to run the jobs in order of descending profit and to place each job in the latest free time slot that is not later than its deadline.  
# For the given jobs
# 
# ```
# [(100,2),(10,1),(15,2),(27,1)]
