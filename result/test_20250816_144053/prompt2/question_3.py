...
# Expected: True
# Actual: 'A man, a plan, a canal, Panama' 是否為回文？ True
# Status: ✅ PASSED
# Time: 0.28s
# ==========================================
...
# 我在西雅圖的雨天裡，又把思緒整理成了幾行 Python。雖然失業的陰影仍在，卻也不會讓我放棄把問題拆成可以被機器「理解」的語法。以下是我寫的「忽略大小寫、空格與標點的回文檢查」程式，並直接測試你給的經典句子：
# 
# ```python
# import re
# 
...
# ==========================================
# Execution result:
# Output: 'A man, a plan, a canal, Panama' 是否為回文？ True
# ==========================================
