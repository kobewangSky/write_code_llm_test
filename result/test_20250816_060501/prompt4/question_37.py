# ==========================================
# Prompt Name: prompt4
# Question 37: Implement Manacher's algorithm for finding the longest palindromic substring: Find the longest palin...
# Expected: racecar,7
# Actual: ERROR
...
# 
# ---
# Now please solve the new question: Implement Manacher's algorithm for finding the longest palindromic substring: Find the longest palindrome in string 'raceacar'. Output the palindrome and its length (format: palindrome,length).
# ==========================================
