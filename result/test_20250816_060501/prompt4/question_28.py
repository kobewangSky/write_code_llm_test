# ==========================================
# Prompt Name: prompt4
# Question 28: Implement Dijkstra's shortest path algorithm: Find shortest distances from source vertex 0 to all ve...
# Expected: [0, 3, 1, 4]
# Actual: [0, 3, 1, 4]
# Status: ✅ PASSED
# Time: 0.03s
...
# 
# ---
# Now please solve the new question: Implement Dijkstra's shortest path algorithm: Find shortest distances from source vertex 0 to all vertices in weighted graph. Graph adjacency list: {0: [(1,4), (2,1)], 1: [(3,1)], 2: [(1,2), (3,5)], 3: []}. Output distances as list [dist_to_0, dist_to_1, dist_to_2, dist_to_3].
# ==========================================
