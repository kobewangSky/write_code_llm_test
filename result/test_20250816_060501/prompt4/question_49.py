...
# Below is a concise implementation of **Mo’s Algorithm** that answers the
...
# Error: Traceback (most recent call last):
  File "/tmp/tmpbyt1jtx3.py", line 83, in <module>
    main()
  File "/tmp/tmpbyt1jtx3.py", line 76, in main
    counts = mos_algorithm(arr, queries)
             ^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/tmp/tmpbyt1jtx3.py", line 21, in mos_algorithm
    indexed_q = [(i // block_size, qidx, qidx) for qidx, i in enumerate(queries)]
                  ~~^^~~~~~~~~~~~
