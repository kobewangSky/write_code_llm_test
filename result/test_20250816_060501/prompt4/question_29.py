# ==========================================
# Prompt Name: prompt4
# Question 29: Implement Bloom Filter: Design a probabilistic data structure for membership testing. Create with si...
...
# 
# ---
# Now please solve the new question: Implement Bloom Filter: Design a probabilistic data structure for membership testing. Create with size 10 and 2 hash functions. Add elements ['apple', 'banana', 'cherry']. Test membership of 'apple', 'grape', 'banana'. Output three boolean values (space-separated).
# ==========================================
