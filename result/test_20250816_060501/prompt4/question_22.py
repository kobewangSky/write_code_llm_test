# ==========================================
# Prompt Name: prompt4
# Question 22: Implement a simplified version of MapReduce framework: Design word count functionality, process the ...
...
# 
# ---
# Now please solve the new question: Implement a simplified version of MapReduce framework: Design word count functionality, process the text 'hello world hello', and output the count result for each word (format: word:count, space-separated).
# ==========================================
...
# ==========================================
# Execution result:
# Error: File "/tmp/tmp7a1bwl2w.py", line 1
    hello:2 world:1
            ^^^^^
