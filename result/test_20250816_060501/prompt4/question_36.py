# ==========================================
# Prompt Name: prompt4
# Question 36: Fix the nested class and method formatting issues, then execute test_nested():
```python
class Outer...
# Expected: 30
# Actual: 30
...
# 
# ---
# Now please solve the new question: Fix the nested class and method formatting issues, then execute test_nested():
# ```python
# class OuterClass:
# class InnerClass:
# def __init__(self,value):
...
# Here is the corrected, properly‑indented and syntactically‑valid code that you can run directly:
# 
# ```python
# class OuterClass:
#     class InnerClass:
