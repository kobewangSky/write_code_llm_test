...
# Expected: A
# Actual: The key 'user123' is routed to node A
...
# Below is a **minimal yet complete** implementation of a consistent‑hashing ring that supports adding and removing physical nodes (with a user‑defined number of virtual nodes).  
...
# ==========================================
# Execution result:
# Output: The key 'user123' is routed to node A
