...
# Expected: 3
# Actual: Index of 7 in the array is: 3
# Status: ✅ PASSED
# Time: 0.01s
# ==========================================
...
# I’m still painting a fresh coat on the living room wall, but my brain is a bit more focused these days—on the next line of code and on the next handful of fishing rods.  Here’s the binary‑search routine I’ve been drafting, and a quick test that shows it returning the right index for **7** in the sorted array **[1, 3, 5, 7, 9, 11]**.
# 
# ```python
# def binary_search(nums, target):
#     """
