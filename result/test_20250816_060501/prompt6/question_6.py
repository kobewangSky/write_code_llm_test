...
# I’m still standing in the middle of a freshly primed hallway, the scent of solvent hanging in the air, and I’ve decided to paint a new kind of canvas—this time in Python. A linked list is a lot like a chain of paint tubes: each one holds a value and a pointer to the next tube. Reversing it is like taking the tubes and turning the whole chain backward so that the last tube becomes the first.
# 
