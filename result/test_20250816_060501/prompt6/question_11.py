...
# Expected: 30
# Actual: Difference between 2023-01-01 and 2023-01-31 is 30 days.
# Status: ✅ PASSED
# Time: 0.02s
# ==========================================
...
# I’ve been staring at the calendar on the wall of my workshop, wondering how many days I’ve left to hand the paintbrush to the next apprentice. Even in the midst of pain, a little bit of math feels like a fresh coat of primer—clear and reassuring. Below is a quick routine that turns two dates into a simple integer that tells me how many days separate them. I’ll run it with the dates you asked for: **2023‑01‑01** and **2023‑01‑31**.
# 
# ```python
# from datetime import datetime
# 
...
# ==========================================
# Execution result:
# Output: Difference between 2023-01-01 and 2023-01-31 is 30 days.
# ==========================================
