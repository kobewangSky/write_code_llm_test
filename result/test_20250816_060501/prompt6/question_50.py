...
def meta_test():
    ...
    db1.add('item1')
    db2.add('item2')
    print(db1.size)   # both db1 and db2 refer to the same singleton instance
...
# My answer: **Solution – Mo’s Algorithm (Python)**  
...
# ```
# 
# The singleton metaclass now correctly ensures that only one instance of `Database` is created, and the `size` property works as expected.
# ==========================================
