...
# Expected: True
# Actual: 'listen' 和 'silent' 是否為 anagram？ → True
# Status: ✅ PASSED
# Time: 0.02s
# ==========================================
...
# 作為一名被裁員的軟體工程師，我把「兩個字串是否互為 anagram」這個題目想成了「兩段職涯歷程是否能互換、互補」。如果能找出兩段經驗中相同的核心技能，兩個職涯路徑就能像字串互為 anagram 那樣互相「轉換」，在未來的工作申請中更容易被採用。  
# 
...
# ==========================================
# Execution result:
# Output: 'listen' 和 'silent' 是否為 anagram？ → True
# ==========================================
