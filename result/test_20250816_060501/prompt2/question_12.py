...
# Implement a simple routine that walks through the array, remembers every element that we’ve already seen and, whenever we hit the same value again, records it in a result set.  
