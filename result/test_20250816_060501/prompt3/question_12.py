...
# Below is a compact helper that scans an array once, keeps track of which numbers it has already seen, and returns a list of the values that appear more than once.
# 
# ```python
# from collections import Counter
# 
