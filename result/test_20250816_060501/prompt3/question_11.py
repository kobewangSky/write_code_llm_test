...
# Below is a small, self‑contained helper that turns the two date strings into real `date` objects, subtracts them, and reports the absolute number of days that separate the two moments in time.
# 
# ```python
# from datetime import datetime
# 
