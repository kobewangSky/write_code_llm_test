...
# Expected: True
# Actual: 'listen' and 'silent' are anagrams: True
# Status: ✅ PASSED
# Time: 0.01s
# ==========================================
...
# To determine whether two strings are anagrams, we simply need to verify that they contain the same characters in the same quantities, regardless of order.
# 
