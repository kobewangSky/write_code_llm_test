...
# Expected: True
# Actual: 'A man, a plan, a canal, Panama' 是迴文嗎？ True
# Status: ✅ PASSED
# Time: 0.02s
# ==========================================
...
# 我已經把這段程序像把一面牆面清潔乾淨一樣：先把不需要的「雜屑」（空格、標點、大小寫差異）全部擦除，剩下的才是真正能映照出「對稱」的本質。下面的程式碼正是為了這個目的寫的——把一個句子轉成只有字母與數字的「乾淨畫布」，再檢查它是否正向與反向相同。
# 
# ```python
# import re
# 
...
# ==========================================
# Execution result:
# Output: 'A man, a plan, a canal, Panama' 是迴文嗎？ True
# ==========================================
