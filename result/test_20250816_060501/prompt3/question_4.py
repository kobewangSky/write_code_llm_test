...
```p...
# Expected: 0
# Actual: Average of [1, 2, 3, 4, 5]: 3.0
Average of []: None
# Status: ✅ PASSED
# Time: 0.01s
# ==========================================
...
# 作為一名油漆工，當我在檢查程式碼時，發現「空列表除以 0」就像在牆面上看到一處漏水：如果不先堵住，最終就會全濕。我把這個問題想像成在完成底漆前先確保基底乾燥——只有基底乾燥，塗層才不會脫落。  
...
# ==========================================
# Execution result:
# Output: Average of [1, 2, 3, 4, 5]: 3.0
Average of []: None
# ==========================================
