...
# **Implementation – Aho‑Corasick multiple‑pattern matcher**
# 
...
# Error: Traceback (most recent call last):
  File "/tmp/tmp3utodcyv.py", line 69, in <module>
    solve()
  File "/tmp/tmp3utodcyv.py", line 61, in solve
    matches = aho_corasick_search(text, patterns)
              ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/tmp/tmp3utodcyv.py", line 40, in aho_corasick_search
    trie, fail, out = build_ac_trie(patterns)
                      ^^^^^^^^^^^^^^^^^^^^^^^
  File "/tmp/tmp3utodcyv.py", line 11, in build_ac_trie
    node = trie[node].setdefault(ch, len(trie))
           ~~~~^^^^^^
