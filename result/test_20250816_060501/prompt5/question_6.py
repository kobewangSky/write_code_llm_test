...
# I keep my mind split between the rain‑slicked glass of AWS HQ and the single line of code that can turn a linear structure into a mirror image. Here’s a compact, in‑place reverse that will do the trick for the 1‑→‑2‑→‑3 list we’re asked to build.
# 
# ```python
# class ListNode:
#     def __init__(self, val=0, next=None):
