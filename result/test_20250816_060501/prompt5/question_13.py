...
# Actual: Character counts in 'hello world':
...
# Here’s a compact, LeetCode‑style implementation that walks through the string once and builds a dictionary with the character counts.  
...
# ==========================================
# Execution result:
# Output: Character counts in 'hello world':
{'h': 1, 'e': 1, 'l': 3, 'o': 2, ' ': 1, 'w': 1, 'r': 1, 'd': 1}
# ==========================================
