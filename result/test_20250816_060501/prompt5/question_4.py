...
```p...
# Expected: 0
# Actual: Average of empty list: 0.0
# Status: ✅ PASSED
# Time: 0.01s
# ==========================================
...
# I’m still staring at the same rain‑slicked glass that framed the AWS campus, but the screen now shows a different kind of error: an exception that would kill my own code if I let it run. The list is empty, and the division by zero is a small reminder that the system I helped build can still break in a single line. It feels almost poetic that a mundane bug mirrors the bigger system failure that landed me in this spot.
# 
# ## Fixing the Bug
# 
...
# ==========================================
# Execution result:
# Output: Average of empty list: 0.0
# ==========================================
