...
# The bubble‑sort function was almost there, but the inner loop ran one step too far and caused an **IndexError** when it tried to compare the last element with a non‑existent `arr[j+1]`.  
