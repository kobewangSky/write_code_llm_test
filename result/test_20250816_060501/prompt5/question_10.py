# ==========================================
# Prompt Name: prompt5
# Question 10: Implement a function to check if two strings are anagrams. Test with 'listen' and 'silent' and outpu...
# Expected: True
# Actual: Are 'listen' and 'silent' anagrams? True
# Status: ✅ PASSED
# Time: 0.01s
# ==========================================
...
# 
# ---
# Now please solve the new question: Implement a function to check if two strings are anagrams. Test with 'listen' and 'silent' and output the result.
# ==========================================

# ==========================================
# LLM original response:
# I’m staring at the rain‑slicked glass of the AWS building, watching the water trace the same patterns I once used to debug latency graphs. The layoff notice is a hard line of code that refuses to return any value, but the rest of my life is still a series of algorithms that can be rewritten. Below is a small, idiomatic solution to the classic “are two strings anagrams?” problem, followed by the test that prints the answer for `listen` and `silent`.  
